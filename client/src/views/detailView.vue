<template>
  <div>
    <div class="p-4 dark:bg-black-800 dark:text-gray-100">
      ...
      <div>
        <section>
          <div class="dark:bg-violet-400">
            ...
            >
              <h1
                class="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl dark:text-gray-900"
              >
                {{ cuisine.name }}
              </h1>
          ...
          <img
            :src="cuisine.imgUrl"
            alt=""
            class="w-5/6 mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40 dark:bg-gray-500"
          />
        </section>
      </div>
    </div>
    <div v-html="cuisine.qr" style="height: 200px; width: 200px"></div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState(useCounterStore, ['cuisine'])
  },
  methods: {
